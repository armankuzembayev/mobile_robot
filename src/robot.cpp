...
#include <mobile_robot/set_float.h>
#include <mobile_robot/set_int.h>
...
mobile_robot::set_int timeStepSrv;
...
int main(int argc, char **argv) {
  ...
  timeStepClient = n->serviceClient<mobile_robot::set_int>("pioneer3at/robot/time_step");
  ...
  for (int i = 0; i < NMOTORS; ++i) {
    ...
    mobile_robot::set_float set_position_srv;
    set_position_client = n->serviceClient<mobile_robot::set_float>(std::string("pioneer3at/") + std::string(motorNames[i]) +
    ...
    mobile_robot::set_float set_velocity_srv;
    set_velocity_client = n->serviceClient<mobile_robot::set_float>(std::string("pioneer3at/") + std::string(motorNames[i]) +
  ...
  mobile_robot::set_int lidar_srv;
  ros::Subscriber sub_lidar_scan;

  set_lidar_client = n->serviceClient<mobile_robot::set_int>("pioneer3at/Sick_LMS_291/enable");
  ...
  mobile_robot::set_int GPS_srv;
  ros::Subscriber sub_GPS;
  set_GPS_client = n->serviceClient<mobile_robot::set_int>("pioneer3at/gps/enable");
  ...
  mobile_robot::set_int inertial_unit_srv;
  ros::Subscriber sub_inertial_unit;
  set_inertial_unit_client = n->serviceClient<mobile_robot::set_int>("pioneer3at/inertial_unit/enable");
  ...
  mobile_robot::set_int accelerometer_srv;
  ros::Subscriber sub_accelerometer;
  set_accelerometer_client = n->serviceClient<mobile_robot::set_int>("pioneer3at/accelerometer/enable");
  accelerometer_srv.request.value = 32;
  set_accelerometer_client.call(accelerometer_srv);
  // enable camera
  ros::ServiceClient set_camera_client;
  mobile_robot::set_int camera_srv;
  ros::Subscriber sub_camera;
  set_camera_client = n->serviceClient<mobile_robot::set_int>("pioneer3at/camera/enable");
  camera_srv.request.value = 64;
  set_camera_client.call(camera_srv);
  // enable gyro
  ros::ServiceClient set_gyro_client;
  mobile_robot::set_int gyro_srv;
  ros::Subscriber sub_gyro;
  set_gyro_client = n->serviceClient<mobile_robot::set_int>("pioneer3at/gyro/enable");
