...
#include <mobile_robot/Float64Stamped.h>
#include <iostream>
...
class Odometry{
 ...
 private:
  ...
  void SpeedCallBack(const mobile_robot::Float64Stamped::ConstPtr& msg);
...
void Odometry::SpeedCallBack(const mobile_robot::Float64Stamped::ConstPtr& msg){
